...
public sealed class CommandDispatcher(
    ...
    ICommandHandler<CheckoutTagRequest, CheckoutTagResponse> checkoutTagCommand,
    ICommandHandler<ReturnToDefaultBranchRequest, ReturnToDefaultBranchResponse> returnToDefaultBranchCommand,
    ...
    ICommandHandler<SetUpstreamBranchRequest, SetUpstreamBranchResponse> setUpstreamBranchCommand,
    ...
    ICommandHandler<GetHeadCommitsRequest, GetHeadCommitsResponse> getHeadCommitsCommand,
    ICommandHandler<ResolveGeneratedPackageReferencesRequest, ResolveGeneratedPackageReferencesResponse> resolveGeneratedPackageReferencesCommand,
    ...
    private readonly IReadOnlyDictionary<string, Func<object, CancellationToken, Task<object?>>> _executors = new Dictionary<string, Func<object, CancellationToken, Task<object?>>>(StringComparer.Ordinal)
    {
        ...
        ["CheckoutTag"] = async (req, ct) => await checkoutTagCommand.ExecuteAsync((CheckoutTagRequest)req, ct),
        ["ReturnToDefaultBranch"] = async (req, ct) => await returnToDefaultBranchCommand.ExecuteAsync((ReturnToDefaultBranchRequest)req, ct),
        ...
        ["SetUpstreamBranch"] = async (req, ct) => await setUpstreamBranchCommand.ExecuteAsync((SetUpstreamBranchRequest)req, ct),
        ...
        [AgentHubMethods.GetHeadCommits] = async (req, ct) => await getHeadCommitsCommand.ExecuteAsync((GetHeadCommitsRequest)req, ct),
        [AgentHubMethods.ResolveGeneratedPackageReferences] = async (req, ct) => await resolveGeneratedPackageReferencesCommand.ExecuteAsync((ResolveGeneratedPackageReferencesRequest)req, ct),
